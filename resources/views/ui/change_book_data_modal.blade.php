  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-6">
            ...
            <div class="alert alert-danger" id="titel_error" role="alert">
          ...
          <div class="col-6">
            ...
            <div class="alert alert-danger" id="publish_error" role="alert">
        ...
        <div class="row mt-2">
          <div class="col-6">
            ...
            <div class="alert alert-danger" id="description_error" role="alert">
          ...
          <div class="col-6">
            ...
            <div class="alert alert-danger" id="writers_error" role="alert">
        ...
        <div class="row mt-2">
          <div class="col-6">
            ...
            <div class="alert alert-danger" id="genre_error" role="alert">
          ...
          <div class="col-6">
            ...
            <div class="alert alert-danger" id="cover_error" role="alert">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success">Módosítás</button>
      </div>
    </div>
  </div>
</div>